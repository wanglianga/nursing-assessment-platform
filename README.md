...
> 加入跌倒事件处置。护理员记录跌倒时间、地点、陪护状态、伤情照片和送医结果；系统暂停相关活动安排，通知家属和评估医生，复盘结论影响后续巡视频次。
> 支持家属临时接回。家属接老人外出过夜时，系统记录接回时间、药品交接、风险告知和预计返院时间；请假期间部分护理费用暂停，返院后需要重新确认健康状态。
...
| 跌倒事件处置 | 跌倒时间/地点/陪护状态/伤情照片/送医结果记录，暂停活动安排，通知家属和医生，复盘结论影响巡视频次 |
| 家属临时接回 | 接回时间、药品交接、风险告知、预计返院时间记录，请假期间费用暂停，返院健康状态确认 |
| 等级复评 | 定期复评提醒、等级变更与计划联动 |
| 费用结算 | 按护理等级计费、增值服务、请假扣减、风险护理费、账单生成 |
| 家属门户 | 服务记录查看、请假外出全流程、费用预估、投诉建议 |
